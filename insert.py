...
class Insert():
    def __init__(self):
        ...
        lbl1 = tk.Label(root, fg='#000', text='Insert Data', font=("Helvetica", 16))  # or font=('Helvetica 17 bold')
        ...
        btn5 = tk.Button(root, bg='#00FFFF', fg='#A77D74', text='Insert Data', width=10, command=lambda: insert())
